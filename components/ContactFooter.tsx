          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              ...
              >
                ...
                <span className="font-medium">sandole97@gmail.com</span>
              ...
              >
                ...
                <span className="font-medium">github.com/sandole</span>
                <ArrowUpRight className="h-4 w-4 text-slate-500 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
              </a>
              <a
              ...
              >
                ...
                <span className="font-medium">linkedin.com/in/minjunseong</span>
                <ArrowUpRight className="h-4 w-4 text-slate-500 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
              </a>
